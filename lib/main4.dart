...
class LoginScreen extends State<MyLoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    //     } else {
    //       dynamic flag = jsonDecode(jsonDecode(jsonEncode('${snapshot.data}')));
    //       print(flag);
          return Scaffold(
        extendBody: true,
        ...
        body: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              TextButton(
                onPressed: () async {
                  var url = Uri.parse('http://10.0.2.2:5000/create?Username=$username1&Password=$confirmpassword&Email=$emailid');
                  var createdatalol = await getdata(url);
                  dynamic crdecoded = jsonDecode(jsonDecode(jsonEncode(createdatalol)));
                  dynamic crflag = crdecoded["flag"];
                  if (crflag == "True") {
                    Navigator.pushReplacementNamed(context, '/login');
                  }
                  else {
  ...
  Widget buildResults(BuildContext context) {
    ...
    return Container(
      ...
      child:  ListView.builder(itemBuilder: (context, index) => ListTile(
        ...
        onTap: () {
          const ProductsList(name: 'The Time Machine', author: 'HG Wells', image: "assets/images/testpdfcover1.jpg" ,
          );
        },
      ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Container(
          ...
          child: const ProductsList(name: 'The Time Machine', author: 'HG Wells', image: "assets/images/testpdfcover1.jpg" ,
        )
    )
    );
  }
...
List<ListWords>  listWords = [
  ListWords('Mystery', 'The Time Machine'),
  ListWords('Thriller', 'Sherlock Holmes'),
  ListWords('Romance', 'Romeo And Juliet'),
  ListWords('Fantasy', 'Harry Potter'),
  ListWords('Adventure', 'The Mysterious Stranger'),
  ListWords('Poetry', 'Why I Write'),
  ListWords('Fiction', 'A Christmas Carol'),
  ListWords('Horror', 'To The Lighthouse'),
];
              ...
              children: [
                ...
                const Card(
                    ...
                    child: Padding(
                        ...
                        child: Text("Read-Points : 500",style: TextStyle(
                            color:Color(0xFFFF8F00),
                            letterSpacing: 2.0,
                            fontWeight: FontWeight.bold
                        ),)
...
class ProductsList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      // children: <Widget>[
        ...
        mainAxisAlignment: MainAxisAlignment.center,
        children: <Widget>[
          Flexible(child: _buildProductItemCard(context)),
    // Row(
    // mainAxisSize: MainAxisSize.max,
    // mainAxisAlignment: MainAxisAlignment.center,
    // children: <Widget>[
    // Flexible(child: _buildProductItemCard2(context)),
    // Row(
    // mainAxisSize: MainAxisSize.max,
    // mainAxisAlignment: MainAxisAlignment.center,
    // children: <Widget>[
    // Flexible(child: _buildProductItemCard3(context)),
    //     ],
    //   ),
    //   ],
    //   ),
  ...
  // _buildProductItemCard2(BuildContext context) {
  //   return Material(
  //     color: Colors.transparent,
  //     child: InkWell(
  //       onTap: () {
  ...
  //   );
  // }
  // _buildProductItemCard3(BuildContext context) {
  //   return Material(
  //     color: Colors.transparent,
  //     child: InkWell(
  //       onTap: () {
...
class PDFScreen extends State<MyPDFScreen> {
  ...
  void initState() {
    ...
    super.initState();
    _pdfViewerController.jumpToPage(pageNo);
    sign = 'true';
    integer().conv(sign);
  }
  @override
